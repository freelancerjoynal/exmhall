				...
				<div class="row align-items-center">
						<div class="col-sm-6">
								<div class="page-title-box">
										<h4 class="font-size-18"> Subjects </h4>
													...
													<tbody>
														<?php 
															if(!empty($subjects_list)) {
																...
																$count = 1;
																foreach($subjects_list as $details) {
														?>
														<tr>
														  <td> <?php echo $details['class_name'];?>  </td>
															...
															<td> 
																<a href="<?php echo base_url('/admin/masters/subject-edit/' . $details['id'])?>">Edit </a>
																&nbsp / &nbsp
																<a href="<?php echo base_url('/admin/masters/subject-delete/' . $details['id'])?>">Delete</a>
															</td>
