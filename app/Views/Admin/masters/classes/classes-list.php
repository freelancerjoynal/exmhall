				...
				<div class="row align-items-center">
						<div class="col-sm-6">
								<div class="page-title-box">
										<h4 class="font-size-18"> Classes </h4>
													...
													<tbody>
														<?php 
															if(!empty($classes_list)) {
																...
																$count = 1;
																foreach($classes_list as $details) {
														?>
														<tr>
															<td> <?php echo $details['class_name'];?>  </td>
															<td> <?php echo get_formatted_date($details['last_update']);?>  </td>
															<td> 
																<a href="<?php echo base_url('/admin/masters/class-edit/' . $details['id'])?>">Edit </a>
																&nbsp / &nbsp 
																<a href="<?php echo base_url('/admin/masters/class-delete/' . $details['id'])?>">Delete</a> 
															</td>
