				...
				<div class="d-flex">
						...
						<div class="navbar-brand-box">
								<a href="<?php echo base_url('admin');?>" class="logo logo-dark">
										<span class="logo-sm">
												<img src="<?php echo base_url('public/assets/frontend/img/logo/Logo.png')?>" alt="" height="22">
										</span>
										<span class="logo-lg">
												<img src="<?php echo base_url('public/assets/frontend/img/logo/Logo.png')?>" alt="" height="17">
										</span>
								</a>
								...
								<a href="<?php echo base_url('admin');?>" class="logo logo-light">
										...
										<span class="logo-lg">
												<img src="<?php echo base_url('public/assets/frontend/img/logo/Logo.png')?>" alt="" height="65">
										</span>
								</a>
						</div>
				...
				<div class="d-flex">
						...
						<div class="dropdown d-none d-md-block ml-2">
								<button type="button" class="btn header-item waves-effect"
										data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										<img class="mr-2" src="<?php echo base_url('public/assets/images/flags/us_flag.jpg')?>" alt="Header Language" height="16"> English <span class="mdi mdi-chevron-down"></span>
								</button>
								<div class="dropdown-menu dropdown-menu-right">
				
										
										<a href="javascript:void(0);" class="dropdown-item notify-item">
												<img src="<?php echo base_url('public/assets/images/flags/germany_flag.jpg')?>" alt="user-image" class="mr-1" height="12"> <span class="align-middle"> German </span>
										</a>

										
										<a href="javascript:void(0);" class="dropdown-item notify-item">
												<img src="<?php echo base_url('public/assets/images/flags/italy_flag.jpg')?>" alt="user-image" class="mr-1" height="12"> <span class="align-middle"> Italian </span>
										</a>
						...
						<div class="dropdown d-inline-block">
								...
								<div class="dropdown-menu dropdown-menu-right">
										...
										<div class="dropdown-divider"></div>
										<a class="dropdown-item text-danger" href="<?php echo base_url('admin/logout')?>"><i class="bx bx-power-off font-size-17 align-middle mr-1 text-danger"></i> Logout</a>
								</div>
						</div>
						...
						<div class="dropdown d-lg-inline-block pt-3">
							<a class="dropdown-item text-danger" href="<?php echo base_url('admin/logout')?>"> <i class="fas fa-sign-out-alt"></i> Logout</a>
						</div>
