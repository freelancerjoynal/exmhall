										...
										<div class="card-body">
												<div class="mb-4">
														<div class="float-left mini-stat-img mr-4">
																<img src="<?php echo base_url('public/assets/images/services-icon/01.png')?>" alt="Total Users">
														</div>
														<h5 class="font-size-16 text-uppercase mt-0 text-white-50">Total Users</h5>
														<h4 class="font-weight-medium font-size-24"> <?php echo isset($dashboard_reports['total_users_count']) ? number_format($dashboard_reports['total_users_count']) : 0;?>
						...
						<div class="col-xl-3 col-md-6">
								<div class="card mini-stat bg-primary text-white">
										<div class="card-body">
												<div class="mb-4">
														<div class="float-left mini-stat-img mr-4">
																<img src="<?php echo base_url('public/assets/images/services-icon/03.png')?>" alt="Current Conversion Rate">
														</div>
														<h5 class="font-size-16 text-uppercase mt-0 text-white-50"> Current Conversion Rate</h5>
														<h4 class="font-weight-medium font-size-24"><?php echo isset($dashboard_reports['current_conversion_rate']) ? $dashboard_reports['current_conversion_rate'] : '0,00';?> 
														<!--<i
						...
						<div class="col-xl-3 col-md-6">
								<div class="card mini-stat bg-primary text-white">
										<div class="card-body">
												<div class="mb-4">
														<div class="float-left mini-stat-img mr-4">
																<img src="<?php echo base_url('public/assets/images/services-icon/02.png');?>" alt="Remaining Coins">
														</div>
														<h5 class="font-size-16 text-uppercase mt-0 text-white-50">Remaining Coins</h5>
														<h4 class="font-weight-medium font-size-24"><?php echo isset($dashboard_reports['total_remaining_coins']) ? get_number_format($dashboard_reports['total_remaining_coins']) : '0,00';?> 
														<!--<i
																		class="mdi mdi-arrow-down text-danger ml-2"></i>-->
														</h4>
								...
								<div class="card mini-stat bg-primary text-white">
										<div class="card-body">
												<div class="mb-4">
														...
														<h5 class="font-size-16 text-uppercase mt-0 text-white-50"> Total Paid Amount</h5>
														<h4 class="font-weight-medium font-size-24"><?php echo isset($dashboard_reports['total_success_transaction_amount']) ? get_number_format($dashboard_reports['total_success_transaction_amount']) : 0;?> 
														<!--<i
																		class="mdi mdi-arrow-up text-success ml-2"></i>-->
																		</h4>
														<!--<div class="mini-stat-label bg-info">
